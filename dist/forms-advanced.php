                ...
                <div class="tab-pane active" id="menu">
                    <nav id="left-sidebar-nav" class="sidebar-nav">
                        <ul id="main-menu" class="metismenu li_animation_delay">
                            ...
                            <li>
                                <a href="gestion_flux.php" class="has-arrow"><i class="fa fa-file"></i><span>Source des revenues</span></a>
                            </li>
                            <li>
                            ...
                            <div class="row clearfix row-deck mt-4">
                                <div class="col-lg-12">
                                    <div class="card">
                                        ...
                                        <form method="POST" action="ajout.php" enctype="multipart/form-data">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        <label>Provenance montant</label>
                                        ...
                                        <div id="test" class="alert alert-success mt-3">
                                            <?= isset($_GET["mess"]) ? $_GET["mess"] : "" ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
