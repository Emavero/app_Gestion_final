...
if(mysqli_connect_errno()){
    die("Failed to connect with MySQL:".mysqli_connect_error());
                 ...
                 $rq1=mysqli_query($conn,"SELECT e.id_provenance_montant,nom_provenance_montant,SUM(montant) AS Somme FROM `encaissement` e ,`provenance_montant` p WHERE e.id_provenance_montant=p.id_provenance_montant and id_type_montant=1 GROUP by e.id_provenance_montant,nom_provenance_montant");
                    ...
                    <div class="card">
						...
						<div class="table-responsive">
                            ...
                            <tr>
                                    ...
                                    <tbody>
                                    <?php
                                     $sql = "SELECT e.id_provenance_montant, nom_provenance_montant, SUM(montant) AS Somme
                                     FROM encaissement e
                                     JOIN provenance_montant p ON e.id_provenance_montant = p.id_provenance_montant
                                     WHERE id_type_montant = 1 and e.actif=1
                                     GROUP BY e.id_provenance_montant, nom_provenance_montant";
                                ...
                                $i=0;
                                 while ($row = $result->fetch_assoc()) {
                                    $i++;
                                     echo "<tr>";
                                     echo "<td>" . $i ."</td>";
                                     echo "<td>" . $row["nom_provenance_montant"] . "</td>";
                                     echo "<td>" . $row["Somme"] . "<strong> FCFA </strong>". "</td>";
                                     echo "</tr>";
                                 }
                             } else {
