    ...
    <nav class="navbar navbar-fixed-top">
        <div class="container-fluid">
            ...
            <form id="navbar-search" class="navbar-form search-form" action="recherche.php" method="GET">
                    <input value="" class="form-control" placeholder="Rechercher un operation" type="text" name="s">
                    <button type="button" class="btn btn-default"><i class="icon-magnifier"></i></button>
                </form> 
                <!--<div id="navbar-menu">
                    <ul class="nav navbar-nav">
                    <li><a href="pdf.php"><i class="fa fa-download"></i>Telecharger</a></li>
                    <li>
                            <a href="pdf.php" class="icon-menu"><i class="fa fa-power-off"></i></a>
                        </li>
                    </ul>
                </div>-->
            </div>
                    ...
                    <div class="card top_widget primary-bg">
                        <div class="body">
                            <div class="content text-light">
                                ...
                                <h4 class="number mb-0"><?php echo $sommeEntree; ?> <strong>FCFA </strong></h4>
                            </div>
            ...
            ?>
                    <div class="card top_widget secondary-bg">
                        <div class="body">
                            <div class="content text-light">
                                ...
                                <h4 class="number mb-0"><?php echo $sommeSortie; ?> <strong>FCFA </strong></h4>
                            </div>
                            <div class="sparkline text-left mt-3" data-type="bar" data-offset="100" data-width="100%" data-height="40px"
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    ...
                    <div class="card top_widget bg-dark">
                        <div class="body">
                            <div class="content text-light">
                                <div class="text mb-2 text-uppercase">Resultat d'exploitation</div>
...
$sql = "SELECT COUNT(*) as total_utilisateurs FROM user";
$result = $conn->query($sql);
...
// Recherche
$searchResults = array(); // Pour stocker les résultats de recherche

if (isset($_GET['s']) && !empty($_GET['s'])) {
    $_recherche = htmlspecialchars($_GET['s']);
    $sql = "SELECT * FROM encaissement e, provenance_montant t, type_encaissement u, type_montant v 
            WHERE e.id_type_encaissement = u.id_type_encaissement 
            AND e.id_type_montant = v.id_type_montant 
            AND e.id_provenance_montant = t.id_provenance_montant
            AND (u.nom_type LIKE '%" . $_recherche . "%'
            OR e.libelle LIKE '%" . $_recherche . "%'
            OR v.nom_type_montant LIKE '%" . $_recherche . "%'
            OR e.montant LIKE '%" . $_recherche . "%'
            OR t.nom_provenance_montant LIKE '%" . $_recherche . "%'
            OR e.date LIKE '%" . $_recherche . "%')";
    $rq1 = mysqli_query($conn, $sql);

    // Stocker les résultats de recherche dans un tableau
