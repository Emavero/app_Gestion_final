                        ...
                        <div class="body">
                            <div class="row clearfix row-deck mt-4">
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="header">
                                            <h2>Editer une provenance montant</h2>
                                        </div>
                                        <div class="row clearfix">
                                <div class="col-md-12">
                                    <div class="card">
                                        ...
                                        <div class="body">
                                            <form action="modifier_provenance_montant.php" method="POST">

                                            <?php
                                         if(isset($_GET['edit'])){
                                           echo '<input type="hidden" name="id_provenance_montant" value="'.$id.'">';
                                              }
            
                                           ?>
                                                
                                              <div class="form-group">
                                                <h6>Editer une provenance montant</h6>
                                              
                                                </div>
                                                <div class="form-group">
                                                    <label>Libellé</label>
                                                    <input type="text" name="nom_provenance_montant" value="<?php echo $nom_provenance_montant; ?>" class="form-control resizable-input" required>
                                                </div>
                                         ...
                                         echo '<div id="test" class="alert alert-success">Modification effectué avec succès !</div>';
