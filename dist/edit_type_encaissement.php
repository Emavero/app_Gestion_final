...
include 'isAdmin.php'; 
include_once("process_type_encaissement.php");
//echo $date;
    ...
    <div id="left-sidebar" class="sidebar">
        ...
        <div class="sidebar-scroll">
            <div class="user-account">
                ...
                <div class="dropdown">
                    <span>Bienvenue</span>
                    <a href="javascript:void(0);" class="dropdown-toggle user-name" data-toggle="dropdown"><strong>Emmanuel</strong></a>
                ...
                <div class="tab-pane active" id="menu">
                    <nav id="left-sidebar-nav" class="sidebar-nav">
                        <ul id="main-menu" class="metismenu li_animation_delay">
                            <li class="active">
                                <a href="index8.php" class="has-arrow"><i class="fa fa-dashboard"></i><span>Accueil</span></a>
                            </li>
                            <li>
                                <a href="#Pages" class="has-arrow"><i class="fa fa-file"></i><span>Bilan</span></a>
                            </li>
                            <li>
                                <a href="#Pages" class="has-arrow"><i class="fa fa-file"></i><span>Source des revenues</span></a>
                            </li>
                            <li>
                        ...
                        <div class="body">
                            <div class="row clearfix row-deck mt-4">
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="header">
                                            <h2>Editer un type encaissement</h2>
                                        </div>
                                        <div class="row clearfix">
                                <div class="col-md-12">
                                    <div class="card">
                                        ...
                                        <div class="body">
                                            <form action="modifier_type_encaissement.php" method="POST">

                                            <?php
                                         if(isset($_GET['edit'])){
                                           echo '<input type="hidden" name="id_type_encaissement" value="'.$id.'">';
                                              }
            
                                           ?>
                                                
                                              <div class="form-group">
                                                <h6>Editer un type encaissement</h6>
                                              
                                                </div>
                                                <div class="form-group">
                                                    <label>Nom type encaissemnt</label>
                                                    <input type="text" name="nom_type" value="<?php echo $nom_type; ?>" class="form-control resizable-input" required>
                                                </div>
...
/*let b1 = document.getElementById('monid');
...
setTimeout("showDiv1()", 800); // aprés 15 sec*/
