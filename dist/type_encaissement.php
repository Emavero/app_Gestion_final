...
.resizable-input {
    width: 550px; /* Vous pouvez ajuster la largeur initiale selon vos besoins */
}
                        ...
                        <div class="body">
                            <div class="row clearfix row-deck mt-4">
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="header">
                                            <h2>Ajouter un type encaissement</h2>
                                        </div>
                                        <div class="row clearfix">
                                <div class="col-md-12">
                                    <div class="card">
                                        ...
                                        <div class="body">
                                            <form  method="post" action="type_encaisse.php">
                                                
                                              
                                                <div class="form-group">
                                                    <label>Type encaissement</label>
                                                    <input type="text" name="type_encaisse" class="form-control resizable-input" required>
                                                </div>
                         ...
                         $rq1=mysqli_query($conn,"SELECT * FROM `type_encaissement` WHERE `type_encaissement`.`actif` =1");
                             ...
                             //var_dump($rst);
                                                               ...
                                                               ?>
                                                                 <tr>
                                                                     ...
                                                                     <td>
                                                                     <a href="edit_type_encaissement.php?edit=<?php echo $rst['id_type_encaissement'];?>"
                                                                           class="btn btn-info"><i class="fa-solid fa-pen-to-square"></i></a>
                                                                      
                                                                           

                                                                           <a href="javascript:void(0);" class="btn btn-danger" onclick="confirmeSuppression(<?php echo $rst['id_type_encaissement'];?>)"><i class="fa-solid fa-trash"></i></a>
...
function confirmeSuppression(id_type_encaissement) {
    ...
    if (confirmation) {
        ...
        window.location.href = "suppression_logique_type_encaissement.php?id_type_encaissement=" + id_type_encaissement;
    } else {
